...
export default function NotFound() {
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center bg-[#F8F9FA] px-6 text-center">
      <div className="w-12 h-12 bg-[#1F3864] rounded-xl flex items-center justify-center mb-5">
      ...
      <Link
        href={home}
        className="bg-[#1F3864] hover:bg-[#162c52] text-white text-sm font-medium px-5 py-2.5 rounded-lg transition-colors"
      >
        Voltar ao início
      </Link>
    </div>
